...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-layout-layout-module"], {
            ...
            var routes = [
                {
                    path: '', component: _layout_component__WEBPACK_IMPORTED_MODULE_3__["LayoutComponent"], children: [
                        ...
                        {
                            path: 'profesor',
                            loadChildren: function () { return Promise.all(/*! import() | profesor-profesor-module */ [__webpack_require__.e("common"), __webpack_require__.e("profesor-profesor-module")]).then(__webpack_require__.bind(null, /*! ../profesor/profesor.module */ "./src/app/pages/profesor/profesor.module.ts")).then(function (m) { return m.ProfesorModule; }); }
                        },
                        {
                            path: 'evento',
                            loadChildren: function () { return Promise.all(/*! import() | evento-evento-module */ [__webpack_require__.e("common"), __webpack_require__.e("evento-evento-module")]).then(__webpack_require__.bind(null, /*! ../evento/evento.module */ "./src/app/pages/evento/evento.module.ts")).then(function (m) { return m.EventoModule; }); }
                        },
                        {
                            path: 'personas',
                            loadChildren: function () { return __webpack_require__.e(/*! import() | personas-personas-module */ "personas-personas-module").then(__webpack_require__.bind(null, /*! ../personas/personas.module */ "./src/app/pages/personas/personas.module.ts")).then(function (m) { return m.PersonasModule; }); }
                        },
                        {
                            path: 'reportes',
                            loadChildren: function () { return __webpack_require__.e(/*! import() | reportes-reportes-module */ "reportes-reportes-module").then(__webpack_require__.bind(null, /*! ../reportes/reportes.module */ "./src/app/pages/reportes/reportes.module.ts")).then(function (m) { return m.ReportesModule; }); }
                        },
                    ]
                }
            ];
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var WrapperComponent = /** @class */ (function () {
                function WrapperComponent(activatedRoute, router) {
                    var _this = this;
                ...
                WrapperComponent.prototype.loadDataComponent = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, this.getUserActive()];
                                case 1:
                                    _a.sent();
                                    return [2 /*return*/];
                            }
                ...
                WrapperComponent.prototype.getUserActive = function () {
                    var _this = this;
                    return this.activatedRoute.data.subscribe(function (res) { return _this.user = res.data; });
                };
                WrapperComponent.prototype.logout = function () {
                    this.isLoading = true;
                    sessionStorage.removeItem("USUARIO");
                    this.router.navigate(['login']);
                    this.isLoading = false;
                };
                WrapperComponent.prototype.handleCollapse = function () {
                    window.innerWidth < 768 ? this.isCollapsed = true : null;
                };
                WrapperComponent.prototype.collapseChange = function () {
                    window.innerWidth < 768 ? this.isCollapsed = false : null;
                };
                WrapperComponent.prototype.collapse = function () {
...
//# sourceMappingURL=pages-layout-layout-module-es5.js.map
//# sourceMappingURL=pages-layout-layout-module-es5.js.map
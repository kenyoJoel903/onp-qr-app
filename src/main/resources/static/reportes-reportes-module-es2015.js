...
let ReporteAsistenciaComponent = class ReporteAsistenciaComponent {
    constructor(message, router, formBuilder, parametroService, eventoService, reporteService) {
    ...
    exportReport() {
        ...
        this.reporteService._exportReporteAsistenciaFecha(this.filter).subscribe(res => {
    ...
    handleFilter() {
        ...
        this.reporteService._getReporteAsistenciaFecha(this.filter).toPromise()
            .then(res => {
            this.listaAsistenciaReporte = res['data'] || [];
    ...
    _listarEventosAll() {
        this.eventoService.getAll().toPromise()
            ...
            this.procesando = false;
            this.message.error('ocurrió un error al recuperar lista de eventos');
        });
    }
    _getAsistencia() {
        this.procesando = false;
...
ReporteAsistenciaComponent.ctorParameters = () => [
...
let ReporteListarComponent = class ReporteListarComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let ReporteSedeComponent = class ReporteSedeComponent {
    constructor(message, router, formBuilder, parametroService, eventoService, reporteService) {
        this.message = message;
        this.router = router;
        this.formBuilder = formBuilder;
...
ReporteSedeComponent.ctorParameters = () => [
...
let ReporteShellComponent = class ReporteShellComponent {
    constructor() {
...
let ReportesService = class ReportesService {
    ...
    _getReporteAsistenciaFecha(data) {
        console.log(JSON.stringify(data));
        return this.api.post(`${this._path}/persona/evento/asistencia`, data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(res => res));
    }
    _exportReporteAsistenciaFecha(data) {
        return this.api.post(`${this._path}/persona/evento/asistencia/export`, data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(res => res));
    }
    _getReporteAnualTipoEvento(data) {
        return this.api.post(`${this._path}/asistencia/sede`, data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(res => res));
    }
    _exportReporteAnualTipoEvento(data) {
        return this.api.post(`${this._path}/asistencia/sede/export`, data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(res => res));
    }
};

...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["profesor-profesor-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProfesorEdicionComponent = /** @class */ (function () {
                function ProfesorEdicionComponent(profesorService, activatedRoute, formBuilder, message, router, cnDataService, modalService) {
                ...
                ProfesorEdicionComponent.prototype.ngOnInit = function () {
                    this._loadLists();
                    this._createForm();
                    this._loadInit();
                };
                ProfesorEdicionComponent.prototype._loadLists = function () {
                    var _this = this;
                    ...
                    this.cnDataService.getCnData('tipo_documentos')
                        .then(function (res) {
                        _this.listaTiposDocumentos = res;
                    });
                    this.procesando = false;
                };
                ProfesorEdicionComponent.prototype._loadInit = function () {
                            ...
                            try {
                                ...
                                if (this.id > 0) {
                                    this.profesorService.getProfesor(this.id).toPromise()
                                        .then(function (res) {
                                        if (res['codigo'] == 100) {
                                            _this.profesorSeleccionado = res['data'];
                                            _this._updateForm();
                                        }
                                    });
                                }
                ...
                ProfesorEdicionComponent.prototype._createForm = function () {
                ...
                ProfesorEdicionComponent.prototype._updateForm = function () {
                    var tipoDoc = this.profesorSeleccionado['tipoDocumento'];
                    tipoDoc = tipoDoc.trim().trim();
                    var activo = this.profesorSeleccionado['activo'] == 'A' ? true : false;
                ...
                ProfesorEdicionComponent.prototype._createMessage = function (type, message) {
                    this.message.create(type, "" + message);
                };
                ProfesorEdicionComponent.prototype.validaCampos = function () {
                ...
                ProfesorEdicionComponent.prototype.modalConfirm = function () {
                    var _this = this;
                ...
                ProfesorEdicionComponent.prototype.guardar = function () {
                    var _this = this;
                    for (var i in this.form.controls) {
                        this.form.controls[i].markAsDirty();
                        this.form.controls[i].updateValueAndValidity();
                    ...
                    if (this.form.status === 'VALID') {
                        ...
                        this.profesorService.create(_data).toPromise()
                            ...
                            if (res['codigo'] === '100') {
                                _this.message.success('Se han actualizado los datos del profesor con éxito.');
                                _this.form.reset();
                                _this.router.navigate([src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].defaultRoute + "/profesor/lista"]);
                            }
                            else {
                            ...
                            _this.procesando = false;
                            _this.message.error("Hubo un error al procesar en la modificaci\u00F3n. Error " + err.status + ": " + err.statusText);
                        });
                    }
                    else {
                        this.procesando = false;
                ...
                ProfesorEdicionComponent.prototype.cancelar = function () {
                    this.router.navigate([src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].defaultRoute + "/profesor/lista"]);
                };
                return ProfesorEdicionComponent;
            }());
            ProfesorEdicionComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProfesorListaComponent = /** @class */ (function () {
                function ProfesorListaComponent(profesorService, message, router, formBuilder, modalService) {
                    var _this = this;
                    this.profesorService = profesorService;
                    this.message = message;
                    this.router = router;
                ...
                ProfesorListaComponent.prototype.ngOnInit = function () {
                    this._loadLists();
                    this._createForm();
                    this._getProfesores();
                };
                ProfesorListaComponent.prototype._loadLists = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                ...
                ProfesorListaComponent.prototype._createForm = function () {
                    this.form = this.formBuilder.group({
                        tipoDocumento: [''],
                        dni: [''],
                        nombre: [''],
                ...
                ProfesorListaComponent.prototype._getProfesores = function () {
                    var _this = this;
                    this.procesando = true;
                ...
                ProfesorListaComponent.prototype.irEditar = function (id) {
                ...
                ProfesorListaComponent.prototype.eliminarSeleccionados = function () {
                    var _this = this;
                    this.procesando = true;
                    this.profesorService.deleteGroup(this.profesoresSeleccionados).toPromise()
                        .then(function (res) {
                        if (res['codigo'] == 100) {
                            _this.message.success('Se eliminó registros satisfactoriamente.');
                            _this.procesando = false;
                            _this._getProfesores();
                        }
                        else {
                ...
                ProfesorListaComponent.prototype.clonarSeleccionado = function () {
                    var _this = this;
                    this.procesando = true;
                    this.profesorService.getProfesor(this.profesoresSeleccionados[0]).toPromise()
                        .then(function (res) {
                        if (res['codigo'] == 100) {
                            var clonado = res['data'];
                            delete clonado.idProfesor;
                            _this.profesorService.create(clonado).toPromise()
                                .then(function (_res) {
                                if (_res['codigo'] == 100) {
                                    _this.procesando = false;
                                    _this._getProfesores();
                                    ...
                                    _this.procesando = false;
                                    _this.message.error('No se puede clonar este registro');
                                }
                            }, function (_err) {
                                _this.procesando = false;
                                _this.message.error('No se puede clonar este registro');
                ...
                ProfesorListaComponent.prototype.handleFilter = function () {
                    var _this = this;
                    var _data = this.form.value;
                ...
                ProfesorListaComponent.prototype.cancelarFiltro = function () {
                    this.form.reset();
                    this._getProfesores();
                };
                ProfesorListaComponent.prototype.checkAllProfesores = function (value) {
                    var _this = this;
                    this.listaProfesores.forEach(function (item) { return (_this.mapOfProfesoresSelected[item.idProfesor] = value); });
                    this.refreshStatusProfesores();
                };
                ProfesorListaComponent.prototype.refreshStatusProfesores = function () {
                    var _this = this;
                    this.isAllProfesoresDisplayDataChecked = this.listaProfesores.every(function (item) { return _this.mapOfProfesoresSelected[item.idProfesor]; });
                    this.isIndeterminateProfesores = this.listaProfesores.some(function (item) { return _this.mapOfProfesoresSelected[item.idProfesor] && !_this.isAllProfesoresDisplayDataChecked; });
                    this.profesoresSeleccionados = [];
                    for (var i in this.mapOfProfesoresSelected) {
                        if (this.mapOfProfesoresSelected[i] == true) {
                            this.profesoresSeleccionados.push(Number(i));
                        }
                    }
                };
                return ProfesorListaComponent;
            }());
            ProfesorListaComponent.ctorParameters = function () { return [
                { type: src_app_services_profesor_service__WEBPACK_IMPORTED_MODULE_3__["ProfesorService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProfesorNuevoComponent = /** @class */ (function () {
                function ProfesorNuevoComponent(formBuilder, message, profesorService, router, cnDataService, modalService) {
                    var _this = this;
                    this.formBuilder = formBuilder;
                    this.message = message;
                    this.profesorService = profesorService;
                    ...
                    this.confirmationValidator = function (control) {
                        if (!control.value) {
                            ...
                            var tipDoc = _this.form.get('tipoDocumento').value;
                ...
                ProfesorNuevoComponent.prototype._loadLists = function () {
                    var _this = this;
                    this.procesando = true;
                    this.cnDataService.getCnData('sexo')
                        .then(function (res) {
                ...
                ProfesorNuevoComponent.prototype._createForm = function () {
                    this.form = this.formBuilder.group({
                        idProfesor: [0, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
                        tipoDocumento: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
                ...
                ProfesorNuevoComponent.prototype.validaCampos = function () {
                    for (var i in this.form.controls) {
                        this.form.controls[i].markAsDirty();
                        this.form.controls[i].updateValueAndValidity();
                    }
                ...
                ProfesorNuevoComponent.prototype.modalConfirm = function () {
                    var _this = this;
                    this.modalService.confirm({
                ...
                ProfesorNuevoComponent.prototype.guardar = function () {
                    var _this = this;
                    for (var i in this.form.controls) {
                        this.form.controls[i].markAsDirty();
                        this.form.controls[i].updateValueAndValidity();
                    ...
                    if (this.form.status === 'VALID') {
                        ...
                        this.profesorService.create(_data).toPromise()
                            ...
                            _this.procesando = false;
                            if (res['codigo'] == 100) {
                                _this.message.success('El profesor ha sido registrado con éxito.');
                                _this.form.reset();
                                _this.router.navigate([src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].defaultRoute + "/profesor/lista"]);
                            }
                            else {
                ...
                ProfesorNuevoComponent.prototype.cancelar = function () {
                ...
                ProfesorNuevoComponent.prototype.numberOnly = function (event) {
                ...
                ProfesorNuevoComponent.prototype.changeTipDoc = function (deviceValue) {
                    this.form.get('dni').setValue("");
                };
                return ProfesorNuevoComponent;
            }());
            ProfesorNuevoComponent.ctorParameters = function () { return [
                { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var ProfesorShellComponent = /** @class */ (function () {
                function ProfesorShellComponent() {
                ...
                ProfesorShellComponent.prototype.ngOnInit = function () {
                };
                ProfesorShellComponent.prototype.handleCollapse = function () {
                    window.innerWidth < 768 ? this.isCollapsed = true : null;
                };
                ProfesorShellComponent.prototype.collapseChange = function () {
                    window.innerWidth < 768 ? this.isCollapsed = false : null;
                };
                return ProfesorShellComponent;
            }());
...
//# sourceMappingURL=profesor-profesor-module-es5.js.map
//# sourceMappingURL=profesor-profesor-module-es5.js.map